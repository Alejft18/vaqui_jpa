...
public class Gestacion {
    ...
    public Gestacion(com.example.vaqui.Entidad.General tbl_general, Double peso_kilos, Date fecha_inseminacion, Date fecha_ultimoParto, Date fecha_Revision, String categoria) {
